    ...
    <div class="col-md-12">
      <div class="panel form-element-padding">
        <div class="panel-heading">
         <h4>Form Edit Peminjaman Buku</h4>
        </div>

        <div class="panel-body" style="padding-bottom:30px;">
          {!! Form::model($pinjam, ['method' => 'PATCH', 'action' => ['PeminjamanController@update', $pinjam->id], 'enctype' => 'multipart/form-data']) !!}
            {{ csrf_field() }}
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  {!! Form::text('kode_peminjaman', null, ['class' => 'form-control', 'disabled']) !!}
                </div>
              </div>
                ...
                <div class="col-md-6">
                  ...
                  @else
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        {!! Form::text('id_anggota', !empty($pinjam) ? $pinjam->id_anggota .' - '. $pinjam->anggotaUserPinjam->name : null, ['class' => 'form-control', 'id'=>'id_anggota', 'style'=>'margin-top: 0px']) !!}
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="form-animate-text">
                      {!! Form::date('tgl_pinjam', !empty($pinjam) ? $pinjam->tgl_pinjam->format('Y-m-d') : null, ['class' => 'form-text datetime', 'disabled']) !!}
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-animate-text">
                      {!! Form::date('tgl_kembali', !empty($pinjam) ? $pinjam->tgl_kembali->format('Y-m-d') : null, ['class' => 'form-text datetime', 'disabled']) !!}
                    </div>
                  </div>
...
$(document).ready(function(){
  ...
  function dynamic_field(number) {
    ...
    html += '<input type="text" name="id_kodebuku[]" class="form-control" id="id_kodebuku'+count+'" placeholder="Masukkan Buku" !empty($pinjam) ? value="{{$pinjam->id_kodebuku . " - ". $pinjam->buku->judul_buku}}" : value=null/>';
